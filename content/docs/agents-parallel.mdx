...
**[ParallelAgent API Reference](/oxyapi/agents-parallel-api)** - 包含完整的构造函数参数、方法签名、并行执行模式和详细的参数描述
...
- [ChatAgent](/docs/agents-chat) - 基础聊天代理
- [ReActAgent](/docs/agents-react) - 推理代理
- [WorkflowAgent](/docs/agents-workflow) - 工作流代理
