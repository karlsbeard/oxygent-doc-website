...
Complete API documentation for the Reflexion and MathReflexion flow classes.
...
- [ChatAgent API](/api-docs/agents-chat-api) - Worker and evaluator agent API
- [ReActAgent API](/api-docs/agents-react-api) - Advanced worker agent API
