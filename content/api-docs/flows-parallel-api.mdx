...
# ParallelFlow API Reference

Complete API documentation for the ParallelFlow class.
...
- [PlanAndSolve API](/api-docs/flows-plan-and-solve-api) - Plan-and-execute flow API
- [Reflexion API](/api-docs/flows-reflexion-api) - Self-evaluation flow API
- [ParallelAgent API](/api-docs/agents-parallel-api) - Intelligent parallel agent API
- [BaseFlow API](/api-docs/base-flow-api) - Base flow class API
