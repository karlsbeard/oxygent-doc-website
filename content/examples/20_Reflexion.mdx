...
This example demonstrates reflexion in OxyGent.
...
oxy_space = [
    ...
    oxy.ReActAgent(
        ...
        func_reflexion=master_reflexion,   # Register reflexion function
    ),
]
...
- This example shows how to use OxyGent for reflexion
