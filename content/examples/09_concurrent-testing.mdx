...
This example demonstrates concurrent test mode in OxyGent.
...
async def main():
    async with MAS(oxy_space=oxy_space) as mas:
        querys = [
            ...
            "What is 35711",
            "What is the 3.5 Mao theory",
        ]
        answers = await mas.start_batch_processing(querys)   # Start batch processing mode
...
- This example shows how to use OxyGent for concurrent test mode
...
```bash
python 09_concurrent_testing.py
```
