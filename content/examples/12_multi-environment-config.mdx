...
This example demonstrates multi-environment configuration in OxyGent.
...
# Configure environment variable APP_ENV = "prod" when deploying
...
- This example shows how to use OxyGent for multi-environment configuration
...
```bash
python 12_multi_environment_config.py
```
