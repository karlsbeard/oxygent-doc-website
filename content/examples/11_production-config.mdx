...
This example demonstrates production configuration in OxyGent.
...
- This example shows how to use OxyGent for production configuration
...
```bash
python 11_production_config.py
```
